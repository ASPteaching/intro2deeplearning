...
Additionally, instead of hand coding the thresholding parameter $\thetha$, we add it as one of the inputs, with the weight $w_0=-\theta$ like shown below, which makes it learnable.
...
[![](images/ActivationFunction0)](https://towardsdatascience.com/everything-you-need-to-know-about-activation-functions-in-deep-learning-models-84ba9f82c253).
...
[![](images/ActivationFunctions)](https://medium.com/@shrutijadon/survey-on-activation-functions-for-deep-learning-9689331ba092).
