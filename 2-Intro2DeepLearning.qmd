...
descent method (\ref{g3}) can be prohibitively expensive 
- because we have
to sum across all training points (for instance in Big Data). 
- A much
...
- therefore we will start from the output
